...
public class Orders {
	...
	public Orders(int id, int customer_id, String name, String email, String contact1, String contact2, String address,
			String state, String city, String zip, String grand_total, String payment_method, String notes,
			String status,
			LocalDateTime added_on, String updated_on) {
		super();
		this.id = id;
		this.customer_id = customer_id;
		this.name = name;
	...
	public String toString() {
		return "Orders [id=" + id + ", customer_id=" + customer_id + ", name=" + name + ", email=" + email
				+ ", contact1="
